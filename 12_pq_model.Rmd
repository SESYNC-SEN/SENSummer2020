...
This notebook:
1. Reads in the labeled results from 11_pq_label_review.Rmd ("11_pq_topics.xlsx")
2. Removes topic 7 based on results review
...
pq_topicsub <- pq_topics %>%
  filter(topic==1 | topic==2 | topic ==3 | topic==4 | topic==5 | topic==6 | topic==10 | topic==11) %>%
